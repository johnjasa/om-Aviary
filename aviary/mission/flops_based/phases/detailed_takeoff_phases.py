...
class TakeoffPhase(PhaseBuilderBase):
    ...
    def build_phase(self, aviary_options=None):
        ...
        if phase_type == '4' or phase_type == '5' or phase_type == '6':
        ...
        elif phase_type == '4' or phase_type == '5' or phase_type == '6':
    ...
    def make_default_transcription(self):
        ...
        if self.phase_type == '4':
            num_segments = 5
        elif self.phase_type == '5' or self.phase_type == '6':
            num_segments = 7
    ...
    def _extra_ode_init_kwargs(self):
        ...
        """
        if self.phase_type == '4' or self.phase_type == '5' or self.phase_type == '6':
            climbing = True
        else:
            climbing = False
